...
d) {
    ...
    ,
    {
        filter: ["width", "items", "settings"], run: function() {
            ...
            c>b;
            b++)a=this._mergers[this.relative(b)], a=this.settings.mergeFit&&Math.min(a, this.settings.items)||a, f+=(this.settings.autoWidth?this._items[this.relative(b)].width()+this.settings.margin: e*a)*d, this._coordinates.push(f)
        }
    }
    ,
    {
        filter: ["width", "items", "settings"], run: function() {
            ...
            !this.settings.autoWidth&&a.grep(this._mergers,
            function(a) {
                return a>1
            }
            ).length>0)for(b=0,
    ...
    e.prototype.setup=function() {
        ...
        c[d]),
        delete e.responsive,
        e.responsiveClass&&this.$element.attr("class",
        function(a,
        b) {
    ...
    e.prototype.update=function() {
        ...
        e= {};
        c>b;
        )(this._invalidated.all||a.grep(this._pipe[b].filter,
        d).length>0)&&this._pipe[b].run(e),
        b++;
        this._invalidated= {}
    }
    ,
    ...
    e.prototype.internalEvents=function() {
        ...
        this.settings.touchDrag&&!c&&this.$stage.on("touchstart touchcancel",
        a.proxy(function(a) {
            this.eventsRouter(a)
        }
        ,
        ...
        !1),
        this.settings.responsive!==!1&&this.on(b,
        "resize",
        a.proxy(this.onThrottledResize,
        this))
    }
    ,
    ...
    e.prototype.closest=function(b) {
        ...
        ,
        this)),
        this.settings.loop||(this.op(b,
        ">",
        f[this.minimum()])?c=b=this.minimum():this.op(b,
        "<",
        f[this.maximum()])&&(c=b=this.maximum())),
        c
    }
    ,
    ...
    ,
    e.prototype.normalize=function(b,
    c) {
    ...
    ,
    e.prototype.duration=function(a,
    b,
    c) {
    ...
    d) {
        ...
        else this.speed(this.duration(this.current(),
        c,
        d)),
        this.current(c),
        this.update()
    ...
    b) {
        ...
        this._items.splice(b,
        0,
        a),
        this._mergers.splice(b,
        0,
    ...
    e.prototype.remove=function(a) {
        ...
        this._items.splice(a,
        1),
        this._mergers.splice(a,
        1),
        this.invalidate("items"),
    ...
    e.prototype.watchVisibility=function() {
        ...
        this.e._checkVisibile=b.setInterval(a.proxy(d,
        this),
        500))
    }
    ,
    ...
    d) {
        ...
        this.settings&&"function"==typeof this.settings[f]&&this.settings[f].apply(this,
        g)),
        g
    }
    ,
    ...
    var c=function(b) {
        this._core=b, this._loaded=[], this._handlers= {
            "initialized.owl.carousel change.owl.carousel": a.proxy(function(b) {
                ...
                g&&a.each(this._core.clones(this._core.relative(f++)),
                h)
            }
            ,
            this)
...
c) {
    ...
    ,
    d.prototype.thumbnail=function(b,
    c) {
...
d) {
    ...
    e.prototype.swap=function() {
        if(1===this.core.settings.items&&this.core.support3d) {
            ...
            ).addClass("animated owl-animated-out").addClass(g).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
            c)),
            f&&e.addClass("animated owl-animated-in").addClass(f).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
            c))
        }
    }
    ,
...
c) {
    var d=function(b) {
        this.core=b, this.core.options=a.extend( {}, d.Defaults, this.core.options), this.handlers= {
            ...
            ,
            this),
            "play.owl.autoplay":a.proxy(function(a,
            b,
            c) {
                this.play(b, c)
            }
    ...
    d.prototype.autoplay=function() {
        ...
        ,
        this),
        this.core.settings.autoplayTimeout)):b.clearInterval(this.interval)
    }
    ,
...
function(a) {
    ...
    b.prototype.initialize=function() {
        ...
        this._controls.$previous.addClass(d.navClass[0]).html(d.navText[0]).hide().prependTo(b).on("click",
        a.proxy(function() {
            this.prev(d.navSpeed)
        }
        ,
        this)),
        this._controls.$next.addClass(d.navClass[1]).html(d.navText[1]).hide().appendTo(b).on("click",
        a.proxy(function() {
            this.next(d.navSpeed)
        }
        ,
        this));
        for(c in this._overrides)this._core[c]=a.proxy(this[c],
        this)
    }
    ,
    b.prototype.destroy=function() {
...
b) {
    ...
    var c=function(d) {
        ...
        this._core.options),
        this.$element.on(this._handlers),
        a(b).on("hashchange.owl.navigation",
        a.proxy(function() {
